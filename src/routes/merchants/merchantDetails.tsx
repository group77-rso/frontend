...
export default function MerchantDetails() {
    ...
    const currencyButtons = <>
        ...
        <Grid.Container gap={2}>
            <Button color={"primary"} bordered={!(currency === "EUR")} disabled={currency === "EUR"} size={"sm"} onClick={() => changeCurrency("EUR")} auto>
                EUR
            </Button>
            <Button color={"primary"} bordered={!(currency === "USD")} disabled={currency === "USD"} size={"sm"} onClick={() => changeCurrency("USD")} auto>
                USD
            </Button>
            <Button color={"primary"} bordered={!(currency === "RUB")} disabled={currency === "RUB"} size={"sm"} onClick={() => changeCurrency("RUB")} auto>
                RUB
            </Button>
            <Button color={"primary"} bordered={!(currency === "JPY")} disabled={currency === "JPY"} size={"sm"} onClick={() => changeCurrency("JPY")} auto>
                JPY
            </Button>
